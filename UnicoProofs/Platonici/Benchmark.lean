...
/-!
FASE 2 — LE DEFINIZIONI DEL BENCHMARK lean-eval (copiate IDENTICHE, 18 lug 2026).

Sorgente: leanprover/lean-eval, `LeanEval/Geometry/PlatonicClassification.lean`
(Kim Morrison). Qui riprodotte parola per parola, nello stesso namespace, SENZA
l'import EvalTools, l'attributo @[eval_problem] e il teorema con sorry.
Queste definizioni sono il contratto della fase 2: ogni nostro risultato è
enunciato su di esse.
-/
